...
*/
  ...
  protected function getNodeOrChildrenNodes($id, $baseReferenceCode, $children = false, $skip = null, $limit = null)
  {
...
// TODO what if a child one doesn't exist? How does previous version handle this?
...
{
  $result['state'] = array('undetermined' => true);
}
*/
